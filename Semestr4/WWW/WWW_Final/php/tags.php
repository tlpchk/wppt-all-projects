<?php
	...
	function createButton($onclick,$value,$id){
		return "<button onclick=\"$onclick\" id=\"cleanLS\">$value</button>"."\n";
	}

	function createLink($href,$id,$value){
		return "<a href=\"$href\" id=\"$id\">$value</a>";
	}
