...
$root = "../";
$title  = "Semestr II";
$description = "Zagadnienia i materiały drugiego semestru";
...
$am2_1 = new CardList("col-6","Czego się nauczyłem","c1");
...
$am2_2 = new CardList("col-6","Materiały","c2");
...
$am2_2->addItem('$ f\prime(a) = \nabla f(a) = \left[\frac{\partial f}{\partial x_1}(a), 
                          \frac{\partial f}{\partial x_2}(a), \ldots, 
...
$algebra_2->addItem('$ a^{p-1} = 1 \mod p$' );
...
$md_1 = new CardList("col-6","Czego się nauczyłem","c1");
...
$md_2 = new CardList("col-6","Materiały","c2");
...
$md_2->addItem('$ \sum\limits_{i=0}^\infty=\frac{1}{1-x}, dla |x|<1$');
...
$kp_1 = new CardList("col-6","Czego się nauczyłem","c1");
...
$kp_2 = new CardList("col-6","Materiały","c2");
...
$fizyka_1 = new CardList("col-6","Czego się nauczyłem","c1");
...
$fizyka_2 = new CardList("col-6","Materiały","c2");
...
$fizyka_2->addItem('$ F_g = G\frac{m_1 m_2}{r^2}$');
$fizyka_2->addItem('$ \vec{F} = m\vec{a}$');
$fizyka_2->addItem('$ E = mc^2=\frac{m_0c^2}{\sqrt{1-\frac{v^2}{c^2}}}$');
...
$problemy_1 = new CardList("col-6","Czego się nauczyłem","c1");
$problemy_1->addItem("Nawyk ciągłego szukania brudnych sztuczek w umowach");


$problemy_2 = new CardList("col-6","Materiały","c2");
