...
$imgsrc = $root."img/codecademy-logo.jpg";
...
$codeacademy = new CardContent($gridSize="col-4", $href,$type="c2",$title="CodeAcademy");
$codeacademy->setDescription($content);
$codeacademy->setImage($imgsrc);
//--------------------------------------------
$href = "https://projecteuler.net";
$imgsrc = $root."img/euler-logo.jpg";
...
$euler = new CardContent($gridSize="col-4", $href,$type="c2",$title="Project Euler");
