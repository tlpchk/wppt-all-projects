...
$mpis_1 = new CardList("col-6 orange","Czego się nauczyłem");
...
$mpis_2 = new CardList("col-6","Materiały");
...
$tp_1 = new CardList("col-6 orange","Czego się nauczyłem");
$tp_1->addItem("UML");
...
$tp_2 = new CardList("col-6","Materiały");
...
$bd_1 = new CardList("col-6 orange","Czego się nauczyłem");
$bd_1->addItem("SQL");
$bd_1->addItem("Algebra relacji");
$bd_1->addItem("Normalizacja baz danych");


$bd_2 = new CardList("col-6","Materiały");
...
$akiso_1 = new CardList("col-6 orange","Czego się nauczyłem");
...
$akiso_2 = new CardList("col-6","Materiały");
